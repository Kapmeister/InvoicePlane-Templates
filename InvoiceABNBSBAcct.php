...
if ($invoice->user_country) {
    ...
    echo 'ABN:' . $custom_fields['user']['ABN'] ;
echo '<br>';
...
<main>
    ...
    <div class="invoice-details clearfix">
        <table class="large">
            <tr>
                <td rowspan="<?php echo $payment_method?->payment_method_name === 'Direct Deposit' ? 7 : ($payment_method?->payment_method_name === null ? 4 : 5) ?>" style="width:60%;text-align:left;"><?php echo $stamp ?></td>    
            </tr>
            <tr>
    ...
    if ($payment_method) {
        ?>
                ...
                <?php if ($payment_method->payment_method_name === 'Direct Deposit') { ?>
                    <tr>
                        <td><?php echo 'BSB:'; ?></td>
                        <td><?php echo $custom_fields['user']['BSB'] ?></td>
                    </tr>
                    <tr>
                        <td><?php echo 'ACCOUNT:'; ?></td>
                        <td><?php echo $custom_fields['user']['Account'] ?></td>
                    </tr>
                <?php } ?>
            <?php
    }
